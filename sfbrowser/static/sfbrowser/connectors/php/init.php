...
echo T.T."<link rel=\"stylesheet\" type=\"text/css\" media=\"screen\" href=\"".SFB_PATH."css/sfbrowser".MIN.".css".CACHE."\" />".N;
...
echo T.T."<script type=\"text/javascript\" src=\"".SFB_PATH."jquery.sfbrowser".MIN.".js".CACHE."\"></script>".N;
